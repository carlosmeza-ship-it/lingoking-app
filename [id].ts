...
export const DOC_DATA: Array<{ name: string; aktenzeichen: string; deadline: string; log: LogEntry[] }> = [
  ...
  { name: 'Gabriela Kimberlyn Moran Caiza', aktenzeichen: '', deadline: '', log: [{ date: '08.06.', note: 'Oberbayern informó que Gabriela es fisioterapeuta, no doctora. Hay que volver a hacer la aplicación. Se pidieron documentos a Manuel.', source: 'doc' }] },
